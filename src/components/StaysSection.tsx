...
const EnquirySection = () => (
  <div className="mt-16 relative w-full h-[400px] md:h-[500px] rounded-[32px] overflow-hidden group">
    <Image
    ...
    <div className="absolute inset-x-8 md:inset-x-12 bottom-8 md:bottom-12 flex justify-between items-end">
      <div className="bg-white/20 backdrop-blur-md px-5 py-2.5 rounded-full flex items-center gap-2 text-white border border-white/30 shadow-xl transition-all hover:bg-white/30">
        <MapPin size={18} fill="white" />
        <span className="text-[14px] md:text-[16px] font-bold tracking-wide">Goa , India</span>
      </div>

      <button className="px-8 md:px-10 py-4 md:py-5 bg-white text-gray-900 rounded-full text-[14px] md:text-[16px] font-bold shadow-2xl transition-all hover:bg-gray-50 hover:scale-105 active:scale-95">
        Enquire Now
      </button>
    </div>
  </div>
