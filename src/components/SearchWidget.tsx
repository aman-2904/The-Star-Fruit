  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 md:px-6 -mt-40  md:-mt-80 relative z-10 transition-all">
      <div className="bg-white/70 backdrop-blur-2xl rounded-[32px] md:rounded-[48px] px-5 py-4 md:px-10 md:py-8 shadow-[0_32px_64px_-16px_rgba(0,0,0,0.25)] border border-white/40">
        ...
        {/* Search Fields Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-2 md:gap-3.5 mb-6 md:mb-8">
          <div className="bg-white/80 p-3.5 md:p-4 rounded-full border border-gray-100/50 shadow-sm hover:shadow-md hover:border-gray-200 transition-all cursor-pointer group">
            ...
            <p className="text-[12.5px] md:text-[14.5px] font-bold text-gray-500 ml-6 md:ml-7">Where to go?</p>
          </div>
