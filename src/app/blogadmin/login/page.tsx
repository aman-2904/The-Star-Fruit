...
type BlogAdminAuthView = 'login' | 'forgot_password' | 'verify_otp' | 'reset_password';
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (view === 'login') {
        ...
        if (user?.user_metadata?.role !== 'blog' && user?.user_metadata?.role !== 'admin') {
          await supabase.auth.signOut();
          throw new Error("Unauthorized. This login is for blog executives only.");
        }
      ...
      <div className="max-w-md w-full bg-white rounded-[32px] p-8 md:p-12 shadow-xl border border-gray-100">
        ...
        <div className="mt-8 text-center">
          {(view === 'forgot_password' || view === 'verify_otp' || view === 'reset_password') ? (
            ...
            <Link href="/blogadmin/signup" className="text-[#EC5B13] font-bold hover:underline">
